...
const ManageQuestions: React.FC = () => {
    ...
    return (
        <div className="w-[100%] h-[100vh] flex justify-center items-start pt-[20px]">
            <div className="w-[50%] p-[40px] border-solid border-r-[1px] border-[#ccc]">
                    ...
                    {listQuestion &&
                        ...
                        listQuestion.map((item) => {
                            return (
                                <div
                                    key={item.id}
                                    className="item-question bg-[#53c1f8] my-[10px] rounded-[10px] cursor-pointer p-[10px]"
                                    onClick={() => setListAnswer(item.answers)}
                                >
                                    <div className="flex justify-between">
                                        ...
                                        <div className="form-action w-[40%] flex justify-around items-center">
                                            <button
